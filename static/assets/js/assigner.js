...
(function() {
  ...
  assignerApp.controller('AssignerForm', function($scope, $http) {
    $scope.form_methods = [
      {
    ...
    $scope.getTimePlaced = function() {
      return new Date().getTime() - 60 * 1000 * $scope.form.minsOld;
    };
    return $scope.submit = function() {
      return $http.post('http://localhost:3000/from-POS', {
